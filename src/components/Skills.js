    ...
    <div className="section skills" id="section-skills">
      <div className="content">
        ...
        <div className="titles">
          <div className="title">Tareas completadas</div>
  ...
  return (
    <div className="section skills" id="section-skills-lang">
      <div className="content">
        {/* title */}
        <div className="titles">
          <div className="title">Hitos alcanzados</div>
  ...
  return (
    <div className="section skills" id="section-skills-code">
      <div className="content">
        {/* title */}
        <div className="titles">
          <div className="title">Porcentajes</div>
          <div className="subtitle">Ejemplos</div>
        </div>
        {/* skills items*/}
